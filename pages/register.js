function renderRegister(app) {
  app.innerHTML = `
    <style>
      ...
      .auth-title { font-size: 1.6rem; font-weight: 800; letter-spacing: -.025em; color: var(--text-primary); text-align: center; margin-bottom: .3rem; }
    ...
    <!-- SVG sutil de fondo -->
    <svg class="reg-bg" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="rb1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#2563eb" stop-opacity=".06"/><stop offset="100%" stop-color="#7c3aed" stop-opacity=".04"/></linearGradient>
        <linearGradient id="rb2" x1="1" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#7c3aed" stop-opacity=".05"/><stop offset="100%" stop-color="#2563eb" stop-opacity=".03"/></linearGradient>
      </defs>
      <!-- Círculo grande esquina superior izquierda -->
      <circle cx="0" cy="0" r="420" fill="url(#rb1)">
        <animate attributeName="r" values="420;450;420" dur="8s" repeatCount="indefinite"/>
      </circle>
      <!-- Círculo grande esquina inferior derecha -->
      <circle cx="1440" cy="900" r="380" fill="url(#rb2)">
        <animate attributeName="r" values="380;410;380" dur="10s" begin="2s" repeatCount="indefinite"/>
      </circle>
      <!-- Círculo medio esquina superior derecha -->
      <circle cx="1440" cy="0" r="260" fill="url(#rb1)" opacity=".7">
        <animate attributeName="r" values="260;285;260" dur="7s" begin="1s" repeatCount="indefinite"/>
      </circle>
      <!-- Círculo pequeño esquina inferior izquierda -->
      <circle cx="0" cy="900" r="200" fill="url(#rb2)" opacity=".6">
        <animate attributeName="r" values="200;220;200" dur="9s" begin="3s" repeatCount="indefinite"/>
      </circle>
      <!-- Líneas diagonales muy sutiles -->
      <line x1="200" y1="0" x2="0" y2="200" stroke="#2563eb" stroke-width="1" opacity=".04"/>
      <line x1="1440" y1="700" x2="1240" y2="900" stroke="#7c3aed" stroke-width="1" opacity=".04"/>
    </svg>
    ...
    <div class="reg-wrap">
      <div class="auth-card">
        ...
        <div style="display:flex;justify-content:center;margin-bottom:1.5rem">
          <svg width="110" height="110" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg" style="filter:drop-shadow(0 8px 24px rgba(124,58,237,.3))">
            <defs>
            ...
            <g>
              <animateTransform attributeName="transform" type="scale" values="0.5;1;1;0.5" dur="2.5s" repeatCount="indefinite" additive="sum" calcMode="spline" keySplines="0.4 0 0.2 1; 0.2 1 0.4 0; 0.4 0 0.2 1"/>
            ...
            <path d="M43 68 l8 8 16-16" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" fill="none" stroke-dasharray="30" stroke-dashoffset="30" opacity="0">
