function renderHome(app) {
  app.innerHTML = `
    <style>
      ...
      body.dark .hero-cta .btn-sec {
        border-color: #475569; color: #e2e8f0;
      }
      body.dark .hero-cta .btn-sec:hover {
        border-color: #60a5fa; color: #60a5fa; background: #1e3a5f;
      }
      ...
      .home-feature-card:hover .feat-icon { transform: scale(1.15) rotate(-5deg); }
    ...
    <div class="home-wrap">
      ...
      <div class="home-hero">
        <div class="hero-text">
          ...
          <div class="hero-cta">
            ...
            <div class="btn-row">
              <a href="#/login"    class="btn-sec">Ingresar</a>
              <a href="#/register" class="btn-sec">Crear cuenta</a>
            </div>
          </div>
        </div>
        ...
        <div class="hero-visual">
          <div class="hero-img-wrap">
            <img
              src="https://cdn-icons-png.flaticon.com/512/5231/5231719.png"
              alt="Examen seguro"/>
          </div>
        </div>
      </div>
      ...
      <div class="stats-strip">
        ...
        <div class="stat-item">
          <span class="stat-num" data-target="0" data-text="En vivo">En vivo</span>
        ...
        <div class="stat-item">
          <span class="stat-num" data-target="0" data-text="∞">∞</span>
  ...
  document.querySelectorAll('.stat-num[data-target]').forEach(el => {
    ...
    if (!target || el.dataset.text) return; // skip non-numeric
    let current = 0;
    const step = Math.ceil(target / 40);
    const tick = setInterval(() => {
      current = Math.min(current + step, target);
      el.textContent = current + (el.dataset.suffix || (target === 100 ? '' : ''));
